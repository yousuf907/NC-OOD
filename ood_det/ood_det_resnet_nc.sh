#!/bin/bash
### ResNet (Ours, w/ NC control) OOD Detection
SAVE_DIR=./lp_results_resnet_det
...
## ID Dataset
SET='imagenet100'
EXPT_NAME=Det_ResNet18_IN_${NUM_CLS}c_etf_proj_ent_reg_${SET}
...
CKPT=best_ResNet18_IN_${NUM_CLS}c_etf_proj_ent_reg_${NUM_CLS}.pth

CUDA_VISIBLE_DEVICES=${GPU} python -u main_resnet_det.py \
--expt_name ${EXPT_NAME} \
--task lin_probe \
--no_wandb 0 \
--nc_control 1 \
