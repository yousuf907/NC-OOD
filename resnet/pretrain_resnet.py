...
from resnet import * # ResNet with BN
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    ## Define Architecture
    ## ResNets-Baseline (output_dim=0, hidden_mlp=0)
    model = resnet18(num_classes=args.num_classes, output_dim=args.output_dim, hidden_mlp=args.hidden_mlp)
    #model = resnet34(num_classes=args.num_classes, output_dim=args.output_dim, hidden_mlp=args.hidden_mlp)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # Train for one epoch
        loss = train_one_epoch(train_loader, model, criterion, optimizer, epoch, args)
